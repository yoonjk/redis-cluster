...
public class RedisListService {
	...
	public Object lrange(PushReqVO pushReqVO) {
		Object items = stringRedisTemplate.opsForList().range(pushReqVO.getKey(), pushReqVO.getStart(),
				pushReqVO.getEnd());
	...
	public long lrem(PushReqVO pushReqVO) {
		long ret = stringRedisTemplate.opsForList().remove(pushReqVO.getKey(), pushReqVO.getStart(),
				pushReqVO.getData()[0]);
