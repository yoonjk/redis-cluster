...
import com.ibm.demo.redis.dto.LeaderBoardReqReq;
import com.ibm.demo.redis.dto.RequestLimitReq;
import com.ibm.demo.redis.dto.Transfer;
import com.ibm.demo.redis.dto.ZRangeByScoreReq;
...
public class LuaController {
	...
	public ResponseEntity<?> runLua(@RequestBody Transfer transfer) {
	...
	public ResponseEntity<?> requestLimitRate(@RequestBody RequestLimitReq requestLimitDto) {
	...
	public ResponseEntity<?> getZRangeByScore(@RequestBody ZRangeByScoreReq zrangeByScoreDto) {
	...
	public ResponseEntity<?> retrieveLeaderBoard(@RequestBody LeaderBoardReqReq leaderBoardReqDto) {
